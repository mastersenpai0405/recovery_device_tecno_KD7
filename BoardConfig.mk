...
DEVICE_PATH := device/tecno/TECNO-KD7
...
# Assert
TARGET_OTA_ASSERT_DEVICE := TECNO-KD7
...
TARGET_KERNEL_SOURCE := kernel/tecno/TECNO-KD7
TARGET_KERNEL_CONFIG := TECNO-KD7_defconfig
